 ...
 */
export async function fillStripeCheckout(page: Page, data: CheckoutFormData): Promise<void> {
 ...
 */
export async function waitForStripeCheckout(page: Page, timeout = 30000): Promise<void> {
